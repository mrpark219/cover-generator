...
function renderModernTemplate(context: TemplateContext) {
  ...
  const titleBlock = fitTextBlock({
    ...
    maxHeight: size * 0.4,
    maxLines: 3,
    maxFontSize: scaleDesign(context, 78),
  ...
  const subtitleBlock = subtitle
    ? fitTextBlock({
        ...
        maxHeight: size * 0.24,
        maxLines: 2,
        maxFontSize: scaleDesign(context, 76),
...
function renderNormalTemplate(context: TemplateContext) {
  ...
  const titleBlock = fitTextBlock({
    ...
    maxHeight: size * 0.34,
    maxLines: 3,
    maxFontSize: scaleDesign(context, 104),
...
function renderClassicTemplate(context: TemplateContext) {
  ...
  const titleBlock = fitTextBlock({
    ...
    maxHeight: size * 0.28,
    maxLines: 3,
    maxFontSize: scaleDesign(context, 62),
  ...
  const subtitleBlock = context.input.subtitle
    ? fitTextBlock({
        ...
        maxHeight: size * 0.24,
        maxLines: 2,
        maxFontSize: scaleDesign(context, 60),
